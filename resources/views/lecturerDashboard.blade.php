            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="username">supun</span>
                        <b class="caret"></b>
                    </a>
    ...
    <aside>
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    {{--{{route('getOrderID',['student_ID'=>140623])}}--}}
                    <a class="" href="{{route('getLecturerID',['Lecturer_ID'=>4000])}}">
...
{{--<table>--}}
    {{--<tr>--}}
        {{--<th>order_ID&emsp; </th>--}}
        {{--<th>&nbsp course_ID &emsp; </th>--}}
        {{--<th>&nbsp course &emsp; </th>--}}


    {{--</tr>--}}

    {{--@foreach($courses_titles as $titles)--}}
        {{--<tr>--}}
