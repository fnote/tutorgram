            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        {{--<li><a class="" href="{{url('operator')}}">Operators</a></li>--}}
                        <li><a class="" href="{{url('operator')}}">Operators</a></li>
                    </ul>
                </li>
                ...
                <section class="panel">
                    ...
                    <table class="table table-hover personal-task">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-important">Uploads</span>
                            </td>
                            <td>
                                    lecturer
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-success">normal class</span>
                            </td>
                            <td>
                                jagath patabendige
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-info">mock exam</span>
                            </td>
                            <td>
                                asoka perera
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-primary">revision</span>
                            </td>
                            <td>
                                sherill malawana
                            </td>
