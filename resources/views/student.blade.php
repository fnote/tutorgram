                ...
                <div class="col-md-6">
                    ...
                    <form action="{{route('createStudent')}}" method="post">
                        ...
                        <div class="form-group {{$errors->has('student_id') ? 'has-error' : ''}}">
                            ...
                            <input class="form-control" type="text" name="student_id" id="student_id" value="{{Request::old('student_id')}}">
                        </div>

                        <div class="form-group {{$errors->has('courses_enrolled') ? 'has-error' : ''}}">
                            <label for="courses_enrolled">courses_enrolled</label>
                            <input class="form-control" type="text" name="courses_enrolled" id="courses_enrolled" value="{{Request::old('student_id')}}">
                        </div>
